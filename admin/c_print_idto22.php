...
function Header()
{
  ...
  global $details;
	...
	$this->Cell(1);
	$this->Cell(10,12,"ลำดับ",1,0,'C',TRUE);
	$this->Cell(25,12,"ออร์เดอร์ไอดี",1,0,'C',TRUE);
		$this->Cell(40,12,"ชื่อ-สกุล",1,0,'C',TRUE);

  $this->Cell(60,12,"วันที่การสั่งซื้อ",1,0,'C',TRUE);
  $this->Cell(30,12,"เบอร์โทรศัพท์",1,1,'C',TRUE);
