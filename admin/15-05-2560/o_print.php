...
$this->Ln(35);
    ...
    $this->Cell(50,12,"ชื่อ - นามสกุล",1,0,'C',TRUE);
  $this->Cell(55,12,"อีเมล",1,0,'C',TRUE);
  $this->Cell(35,12,"เบอร์โทรศัพท์",1,0,'C',TRUE);
  $this->Cell(50,12,"วันเวลาที่สั่งสินค้า",1,1,'C',TRUE);
